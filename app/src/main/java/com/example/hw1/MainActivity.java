        ...
        initBill.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                try{
                    ...
                    tenPTip.setText(String.format("0.00"));
                    fifPTip.setText(String.format("0.00"));
                    twenPTip.setText(String.format("0.00"));

                    tenPTot.setText(String.format("0.00"));
                    fifPTot.setText(String.format("0.00"));
                    twenPTot.setText(String.format("0.00"));
                    custTip.setText(String.format("0.00"));
                    custTot.setText(String.format("0.00"));
                    return;
                }
